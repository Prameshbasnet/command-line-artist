...
const IntroSequence: React.FC<IntroSequenceProps> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={cursorRef}
        className="fixed w-12 h-12 pointer-events-none z-[60] mix-blend-difference"
        style={{ 
          left: 0, 
          top: 0,
      ...
      >
        <motion.div
          ...
          className="w-full h-full rounded-full border-2 border-cyan-400 flex items-center justify-center"
        >
